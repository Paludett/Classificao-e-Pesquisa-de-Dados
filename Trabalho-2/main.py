import random
import time
from sorts import mergesort, mergesort_otimizado, heapsort, heapsort_otimizado, quicksort, quicksort_otimizado, counting_sort, radix_sort, bucket_sort
...
def main(): 
    ...
    algoritmos = [
        ...
        ("Mergesort",           mergesort),
        ("Mergesort Otimizado",       mergesort_otimizado),
        ("Heapsort",            heapsort),
        ("Heapsort Otimizado",        heapsort_otimizado),
        ("Quicksort",           quicksort),
        ("Quicksort Otimizado",       quicksort_otimizado),
